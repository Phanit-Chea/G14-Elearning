...
?>
        <tr> 
                ...
                <td> 
                    <a onclick="return confirm('Do you want to delete this category?')" class="btn btn-sm btn-primary" href="controllers/trainers/category/trainer_delete_category.controller.php?id=<?= $category['category_id'] ?>"><i class="bi bi-trash-fill"></i></a> 
            ...
            <div class="modal fade" id="edit-modal<?= $category['category_id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"> 
              <div class="modal-dialog"> 
                <div class="modal-content"> 
                  ...
                  <form action="controllers/trainers/category/trainer_edit_category.controller.php" method="post"> 
