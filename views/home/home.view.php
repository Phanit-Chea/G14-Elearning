				...
				<div class="col-md-8 text-center mx-auto pb-5">
					<form action="" class="bg-body shadow rounded p-2" method="GET">
						<div class="input-group">
							<input class="form-control border-0 me-1" type="text" name="search"
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card card-body shadow rounded-3">
							<div class="d-flex align-items-center">
								...
								<div class="ms-3">
									<h5 class="mb-0"><a href="#" class="stretched-link"
											value="<?= $category['category_name'] ?>"></a>
							...
							<div class="card p-2 shadow h-100">
								<div class="rounded-top overflow-hidden">
									<div class="card-overlay-hover">
										<!-- Image -->
										<img style="width: 330px; height:200px"
											src="assets/images/courses/4by3/<?= $course['course_image'] ?>" class="card-img-top"
											alt="course image">
									</div>
									<!-- Hover element -->
									<div class="card-img-overlay">
								...
								<div class="card-body px-2">
									...
									<div class="d-flex justify-content-between">
										...
										<ul class="list-inline hstack gap-2 mb-0">
											...
											<!-- Rating -->
											<li class="list-inline-item d-flex justify-content-center align-items-center">
												<div class="icon-md bg-warning bg-opacity-15 text-warning rounded-circle"><i
										...
										<div class="avatar avatar-sm">
											<img class="avatar-img rounded-circle"
												src="assets/images/avatar/<?= $course['image'] ?>" alt="avatar">
										</div>
									</div>
									<!-- Divider -->
									<hr>
									...
									<div class="d-flex justify-content-between align-items-center mb-0">
										<div><a href="#" class="badge bg-info bg-opacity-10 text-info me-2"><i
													class="fas fa-circle small fw-bold"></i>
					...
					<?php foreach ($top_courses as $course): ?>
						...
						<div class="col-md-6 col-lg-4 col-xxl-3">
							...
							<div class="card card-metro overflow-hidden rounded-3">
								<img style="width: 360px; height:200px"
									src="assets/images/courses/4by3/<?= $course['course_image'] ?>" alt="">
								<!-- Image overlay -->
								...
								<div class="tiny-slider-inner" data-autoplay="false" data-edge="2" data-arrow="true"
									...
									<div>
										<div class="card p-2">
											<div class="position-relative">
												<!-- Image -->
												<img src="assets/images/courses/4by3/inVistion.jpg" class="card-img rounded-2"
													alt="Card image">
												<div class="card-img-overlay">
													<div class="position-absolute top-50 start-50 translate-middle">
														<!-- Video link -->
													...
													<div>
														...
														<ul class="avatar-group mb-2 mb-sm-0">
															<li class="avatar avatar-xs">
																<img class="avatar-img rounded-circle"
																	src="assets/images/courses/4by3/rady.jpg" alt="avatar">
															</li>
															<li class="avatar avatar-xs">
																<img class="avatar-img rounded-circle"
																	src="assets/images/courses/4by3/rady.jpg" alt="avatar">
									...
									<div>
										<div class="card p-2">
											<div class="position-relative">
												<!-- Image -->
												<img src="assets/images/courses/4by3/PHP max.png" class="card-img rounded-2"
													alt="Card image">
												<div class="card-img-overlay">
													<div class="position-absolute top-50 start-50 translate-middle">
														<!-- Video link -->
												...
												<div class="d-sm-flex justify-content-sm-between align-items-center mt-3">
													...
													<div>
														...
														<ul class="avatar-group mb-2 mb-sm-0">
															<li class="avatar avatar-xs">
																<img class="avatar-img rounded-circle"
																	src="assets/images/courses/4by3/himhey.jpg" alt="avatar">
															</li>
															<li class="avatar avatar-xs">
																<img class="avatar-img rounded-circle"
																	src="assets/images/courses/4by3/himhey.jpg" alt="avatar">
									...
									<div>
										<div class="card p-2">
											<div class="position-relative">
												<!-- Image -->
												<img src="assets/images/courses/4by3/21.jpg" class="card-img rounded-2"
													alt="Card image">
												<div class="card-img-overlay">
													<div class="position-absolute top-50 start-50 translate-middle">
														<!-- Video link -->
