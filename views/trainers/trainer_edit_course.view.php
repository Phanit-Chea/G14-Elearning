<body>
    ...
    <main class=" h-100">
        ...
        <div class="container">
            <form action="controllers/trainers/trainer_update_course.controller.php" method="POST" enctype="multipart/form-data" class="w-100 row g-2 d-flex justify-content-between " style="margin-right: 20px ;">
                <div class="col col-4 bg bg-white mb-2 mt-1 d-flex flex-column align-items-center border border">
                    <img src="assets/images/courses/4by3/<?= $course['course_image'] ?>" alt="" class="p-3 h-500" id="courseImage">
                    <button type="button" class="btn btn-outline-danger btn-sm mb-2" onclick="document.getElementById('imageInput').click()">Change image</button>
                ...
                <div class="col">
                    ...
                    <div class="form-group mt-3 col-sm-12">
                        <input type="number" class="form-control" id="course_duration" name="course_duration" placeholder="Enter course duration" value="<?= $course['course_duration']; ?>" required>
                    </div>
                    <div class="form-group mt-3 col-sm-12">
                    ...
                    <div class="form-group mt-3 col-sm-12">
                        <select class="form-select" id="course_category" name="course_category" required>
                            ...
                            foreach ($categories as $category) :
                                $selected = ($course['category_name'] === $category['category_name']) ? "selected" : "";
                            ?>
                    ...
                    <div class="form-group mt-3 col-12">
                        <textarea class="form-control" id="description" rows="3" name="description" required><?= $course['description'] ?></textarea>
                    </div>
                    <div class="d-grid gap-2">
                        <button class="btn btn-danger mt-3">Update new course</button>
                    </div>
                </div>
