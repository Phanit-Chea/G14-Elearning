                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center position-relative">
                                                            ...
                                                            <div class="avatar avatar-md mb-2 mb-md-0">
                                                                <img src="assets/images/avatar/<?php echo $student['image'] ?>" class="rounded" alt="">
                                                            </div>
                                                            <div class="mb-0 ms-2">
                                                                <!-- Title -->
                                                                <h6 class="mb-0"><a href="#" class="stretched-link"><?php
                                                    ...
                                                    <td><?php echo $student['enrollement_date'] ?></td>
                                                    <td>
