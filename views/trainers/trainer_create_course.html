        ...
        <section class="d-flex justify-content-around">
            ...
            <div class="container">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control form-control-lg" id="course_name" placeholder="Course Name">
                </div>
                <div class="mb-4">
                    <input type="text" class="form-control form-control-lg" id="course_duration"
                        placeholder="Time duration">
                </div>
                <div class="mb-4">
                    <input type="text" class="form-control form-control-lg" id="course_price"
                        placeholder="Course Price">
                </div>
                <div class="dropdown">
                    <button class="btn border" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        Choose Cateory
                    </button>
                    <ul class="dropdown-menu " aria-labelledby="dropdownMenuButton2">
                        <li><a class="dropdown-item active" href="#">Web Design</a></li>
                        <li><a class="dropdown-item" href="#">Web development</a></li>
                        <li><a class="dropdown-item" href="#">IT software</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item" href="#">Network System Administrator</a></li>
                    </ul>
                </div>
                <div class="mt-4">
                ...
                <div class="d-grid gap-2 mt-4">
                    <button class="btn btn-primary" type="button">Add New Course</button>
                </div>
            </div>
        </section>
