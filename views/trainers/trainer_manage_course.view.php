							...
							<div class="offcanvas-body p-3 p-xl-0">
								<div class="bg-dark border rounded-3 pb-0 p-3 w-100">
									...
									<div class="list-group list-group-dark list-group-borderless">
										...
										<!-- <a class="list-group-item" href="/trainer_manage_course" active><i class="bi bi-basket fa-fw me-2"></i>My Courses</a> -->
	...
	<div class="modal-dialog">
		...
		<div class="modal-content bg-secondary">
			<div class="modal-header">
				<h5 class="modal-title text-white text-center" id="exampleModalLabel">Create Course</h5>
			...
			<div class="modal-body">
				<form action="controllers/trainers/trainer_create_course.controller.php" method="POST" enctype="multipart/form-data" class="w-100 row g-2">
					<div class="form-group mt-3 ">
						...
						<input type="text" class="form-control" id="course_name" name="course_name" placeholder="Enter your course name!" required>
					</div>
					...
					<div class="form-group mt-3 col-sm-6">
						<label for="course_name">Course Video</label>
						<input class="form-control" id="course_video" type="file" name="course_video" required>
					</div>

					<div class="form-group mt-3 col-sm-12">
						<label for="course_name">Course Categories</label>
					...
					<div class="col-12">
						<button type="submit" class="btn btn-primary"><input type="hidden" name="user_id" value="<?=$user_id?>">Create</button>
