						...
						<div class="card bg-transparent card-body p-0">
							<div class="row d-flex justify-content-between">
								...
								<div class="col d-md-flex justify-content-between align-items-center mt-4">
									<div>
										<h1 class="my-1 fs-4">
											<?php echo $username; ?> <i class="bi bi-patch-check-fill text-info small"></i>
										</h1>
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td>
														<div>
															<img src="../../assets/images/courses/4by3/<?= $lesson['image']; ?>" alt="" class="w-60px h-60px rounded">
														</div>
													</td>
													...
													<td class="d-flex text-center text-sm-center pb-5 pt-5 justify-content-center">
														<form action="" method="post">
															<input type="hidden" name="course_id" value="<?= $lesson['lesson_id'] ?>">
															<button type="button" class="btn btn-sm btn-success-soft btn-round me-1 mb-0" data-bs-toggle="modal" data-bs-target="#edit_modal<?= $lesson["lesson_id"] ?>">
...
Inner part END -->
	...
	<?php foreach ($lessons as $lesson) : ?>
		<div class="modal fade" id="edit_modal<?= $lesson["lesson_id"] ?>" tabindex="-1" aria-labelledby="example" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header bg-sucess">
					...
					<div class="modal-body bg-secondary">
						<form action="controllers/trainers/trainer_edit_lesson.controller.php" method="post" enctype="multipart/form-data">
							<div class="form-floating mb-3">
								<input type="text" class="form-control" id="name" name="lesson_title" value="<?php echo $lesson["title"]; ?>">
								<label for="name">Lesson Title</label>
							</div>
							...
							<div class="form-floating mb-4">
								<input type="text" class="form-control" id="description" name="lesson_description" value="<?php echo $lesson["lesson_description"]; ?>">
								<label for="description">Description</label>
							</div>
