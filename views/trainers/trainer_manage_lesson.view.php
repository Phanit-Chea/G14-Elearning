										...
										<tbody>
											...
											foreach ($lessons as $lesson):
												...
												<tr>
													...
													<td>
														<div>
															<img src="../../assets/images/avatar/<?= $lesson['image']; ?>"
													...
													<td>
														<p class="h6 fw-light mb-0 small me-3 text-center">
															<?php $nb_vdo_free = nb_vdo_free($lesson['lesson_id']);
													...
													<td>
														<p class="h6 fw-light mb-0 small me-3 text-center"></i>
															<?php $nb_vdo_not_free = nb_vdo_not_free($lesson['lesson_id']);
